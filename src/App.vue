<template>
	<div id="app">
		<div class="demo">
			<input type="text" class="cityinput" id="citySelect" value="城市名" v-on:click="select">
		</div>
		<input type="button"value="提交" v-on:click="greet">
		<div>
			<router-link to="/forecast"><button class="btn btn-info">实时天气</button></router-link>
			<router-link to="/air"><button class="btn btn-success">空气指数</button></router-link>
			<router-link to="/suggestion"><button class="btn btn-warning">生活指数</button></router-link>
	...
	export default {
		methods: {
			...
			greet: function() {
				...
				var url = `https://free-api.heweather.com/v5/weather?city=${city}&key=3cf2f03bdff746718435359cadf0d9b0`;
